...
The `github-app` and `github-app-main` collectors require a `GH_TOKEN` secret for GitHub API access. The `github-app-main` collector additionally requires `PG_PASSWORD` for database queries.
