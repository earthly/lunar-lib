...
- [ ] CI is green
- [ ] CodeRabbit review comments addressed (the Bender server auto-summons CodeRabbit on the draft→ready transition; you only need to have replied to / resolved every thread it left)
